...
## 01. Ad safety at a decision point
...
## 02. Four presenters, one evidence chain
...
## 03. Manual review fails on ambiguous creatives
...
## 06. Source style predicts labels
...
## 07. Separate evidence streams before policy
...
## 08. Test evidence stayed untouched

Presenter section: Bickramjit Basu

I froze both the V-I-T and ResNet-fifty backbones, cached their embeddings, and fit logistic heads only on training data. I selected conservative class thresholds on validation data. I opened the 48-image test set once for final reporting. I also benchmarked warm batch-one C-P-U inference with one thread so the timing protocol stays reproducible.

## 09. Research supports components, not claims
...
## 11. One grenade crossed the class boundary
...
## 12. External audit breaks confidence
...
## 13. One workspace carries a case from upload to audit
...
## 18. Controls needed before an MVP trial
...
## 19. A recommended 10-week path to MVP
